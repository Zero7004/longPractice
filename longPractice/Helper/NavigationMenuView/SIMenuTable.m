...
//    return cell;
    ...
    SIMenuCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (!cell) {
        cell = [[SIMenuCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setSelected:NO withCompletionBlock:^{
        [self.menuDelegate didSelectItemAtIndex:indexPath.row textString:self.items[indexPath.row]];
    }];
    cell.backgroundColor = [UIColor whiteColor];
}
