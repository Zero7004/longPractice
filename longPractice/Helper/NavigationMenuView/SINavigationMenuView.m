...
//        self.table = [[SIMenuTable alloc] initWithFrame:self.menuContainer.frame items:self.items];
        self.table = [[SIMenuTable alloc] initWithFrame:CGRectMake(0, 64, SCREEN_WIDTH, SCREEN_HEIGHT) items:self.items];
...
- (void)didSelectItemAtIndex:(NSUInteger)index textString:(NSString *)textString
{
    self.menuButton.title.text = textString;
