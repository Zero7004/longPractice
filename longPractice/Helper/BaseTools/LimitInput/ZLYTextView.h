...
- (void)textViewLimitLengh:(ZLYTextView *)textView;
@end
...
//textfield输入内容的起始坐标
@property (nonatomic         ) CGPoint   textPoint;   // default is (5,8)
//可输入字数
@property (assign , nonatomic) NSInteger canEnterWordsNumber;

@property (nonatomic, weak) id<ZLYTextViewDelegate> textDelegate;
